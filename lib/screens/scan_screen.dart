...
class _ScanScreenState extends State<ScanScreen>
  ...
  Future<void> _analyzeImage() async {
    ...
    try {
      ...
      // For testing, ensure your Flask server is running and accessible on this IP.
      // On an emulator, '10.0.2.2' often refers to the host machine's localhost.
      // On a physical device, use the actual local network IP of your server.
      final uri = Uri.parse("http://10.15.65.117:5000/analyze");
